...
/* Navigation
------------------------------------*/
.casawp-single .distance__navwrap .address_wrap {
  display: block;
  line-height: 84px; }

.casawp-single .distance__navwrap .address_wrap .address_property {
  float: left;
  font-weight: 400;
  color: #3C3C3C; }

.casawp-single .distance__navwrap .address_wrap svg {
  display: block;
  float: left; }
...
.casawp-single .casadistance__menu__button, .casadistance__menu__button {
  ...
  @media (min-width: 768px) {
    .casawp-single .casadistance__menu__button, .casadistance__menu__button {
      width: 84px;
      display: block; } }
  .casawp-single .casadistance__menu__button:hover, .casawp-single .casadistance__menu__button:focus, .casawp-single .casadistance__menu__button:active, .casadistance__menu__button:hover, .casadistance__menu__button:focus, .casadistance__menu__button:active {
    background: #20c997;
    cursor: pointer; }
    .casawp-single .casadistance__menu__button:hover svg path, .casawp-single .casadistance__menu__button:focus svg path, .casawp-single .casadistance__menu__button:active svg path, .casadistance__menu__button:hover svg path, .casadistance__menu__button:focus svg path, .casadistance__menu__button:active svg path {
      fill: #fff; }
    .casawp-single .casadistance__menu__button:hover span, .casawp-single .casadistance__menu__button:focus span, .casawp-single .casadistance__menu__button:active span, .casadistance__menu__button:hover span, .casadistance__menu__button:focus span, .casadistance__menu__button:active span {
      color: #fff; }
...
.casadistance__result__listitem {
  ...
  .casadistance__result__listitem .fa-layers {
    flex: 40px 0 0; }
  .casadistance__result__listitem .casadistance__result__listitem__title {
    flex: 100% 1 1;
    margin-top: 0px;
    margin-bottom: 0px; }
  .casadistance__result__listitem .casadistance__result__listitem__subtitle {
    display: block;
    font-size: .75rem;
    color: #666; }
