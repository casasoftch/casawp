...
class Map{
	...
	*/
	...
	renderMarker(position, title, type, index, property, id){
		...
		if (type !== this.markerIcon) {
			...
			// google.maps.event.addListener(marker, 'click', (event) => { this.locationOnClickAction(event, locationTitle, locationCoords, locationType, property, index)});
			// google.maps.event.addListener(marker, 'mouseover', (event) => { this.locationOnMouseOverAction(event, index)});
			// google.maps.event.addListener(marker, 'mouseout', (event) => { this.locationOnMouseOutAction(event)});
		}
	...
	locationOnMouseOutAction (event, id) {
	...
	*/
	...
	renderNearbyData(item, index){
		...
		listing.addEventListener('mouseover', (event) => { this.locationOnMouseOverAction(event, index)});
		listing.addEventListener('mouseout', (event) => { this.locationOnMouseOutAction(event)});
		return listing;
	}
