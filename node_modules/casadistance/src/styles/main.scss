...
.casadistance__placeholder {
    height: (350px + 85px);
    line-height: (350px + 85px);;
    @media (min-width: 992px) {
        height: (700px + 85px);
        line-height: (700px + 85px);
    }
    text-align: center;
    background-color: #eeeeee
}

.casadistance__placeholder__show-btn {
...
.casadistance__result__listitem__title{
    ...
    flex: 100% 1 1;
    font-size: 1*$fakerem;
    line-height: 1.5*$fakerem;
}
.casadistance__result__listitem__subtitle{
    color: #666;
    font-size: .75*$fakerem;
    display: block;
    line-height: 1.5*$fakerem;
}
...
.casadistance__result__listitem__number {
    ...
    font-size: 2*$fakerem;
    font-weight: 400;
    line-height: 3*$fakerem;
    margin-right: 1*$fakerem;
    text-align: center;
    vertical-align: top;
    width: 2*$fakerem;
}
