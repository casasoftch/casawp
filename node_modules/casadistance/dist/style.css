...
.casadistance__menu__button {
  ...
  @media (min-width: 768px) {
    .casadistance__menu__button {
      width: 84px;
      display: block; } }
  .casadistance__menu__button .button__inner {
    position: absolute;
    left: 50%;
    top: 50%;
    transform: translate(-50%, -50%);
    text-align: center; }
    .casadistance__menu__button .button__inner svg {
      margin-bottom: 5px; }
      .casadistance__menu__button .button__inner svg path {
        transition: 0.2s all; }
    .casadistance__menu__button .button__inner span {
      font-size: 11px;
      line-height: 11px;
      font-weight: 500;
      display: block;
...
.casadistance__result__listitem--active {
  background-color: black;
  color: white; }
