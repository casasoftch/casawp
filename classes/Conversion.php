  ...
  class Conversion {
    ...
    public function casawp_convert_categoryKeyToLabel($key, $fallback = ''){
        ...
        if (!$label) {
          switch ($key) {
              ...
              case 'bed-and-breakfast':      $label = __('Bed and breakfast' ,'casawp');break;
              case 'building-land':      $label = __('Building land' ,'casawp');break;
              case 'boat-dry-dock':      $label = __('Boat dry dock' ,'casawp');break;
              case 'boat-landing-stage':      $label = __('Boat landing stage' ,'casawp');break;
              case 'boat-mooring':      $label = __('Boat mooring' ,'casawp');break;
              case 'double-garage':      $label = __('Double garage' ,'casawp');break;
              case 'campground':      $label = __('Campground / Tent camping' ,'casawp');break;
              case 'duplex':      $label = __('Duplex' ,'casawp');break;
              case 'car-park':      $label = __('Car park' ,'casawp');break;
              case 'car-repair-shop':      $label = __('Car repair shop' ,'casawp');break;
              ...
              case 'agricultural-land':     $label = __('Agricultural land' ,'casawp');break;
              case 'agricultural-lot':     $label = __('Agricultural lot' ,'casawp');break;
              case 'allotment-garden':     $label = __('Allotment garden' ,'casawp');break;
              case 'arcade':     $label = __('Arcade' ,'casawp');break;
              case 'attic-compartment':     $label = __('Attic compartment' ,'casawp');break;
              ...
              case 'carpentry-shop':      $label = __('Carpentry shop' ,'casawp');break;
              case 'castle':      $label = __('Castle' ,'casawp');break;
              case 'cellar-compartment':      $label = __('Cellar compartment' ,'casawp');break;
              case 'cheese-factory':      $label = __('Cheese factory' ,'casawp');break;
              case 'commercial-building-plot':      $label = __('Commercial building plot' ,'casawp');break;
              case 'commercial-plot':      $label = __('Commercial plot' ,'casawp');break;
              case 'commercial-premises':      $label = __('Commercial premises' ,'casawp');break;
              case 'construction-project':      $label = __('Construction project' ,'casawp');break;
              case 'covered-bike-space':      $label = __('Covered bike space' ,'casawp');break;
              case 'covered-slot':      $label = __('Covered slot' ,'casawp');break;
              case 'display-window':      $label = __('Display window' ,'casawp');break;
              case 'doctors-office':      $label = __('Doctors office' ,'casawp');break;
              case 'earth-sheltered-dwelling':      $label = __('Earth sheltered dwelling' ,'casawp');break;
              case 'ground-floor-flat':      $label = __('Ground floor flat' ,'casawp');break;
              case 'engadine-house':      $label = __('Engadine house' ,'casawp');break;
              case 'exhibition-space':      $label = __('Exhibition space' ,'casawp');break;
              case 'flat':      $label = __('Flat' ,'casawp');break;
              case 'fuel-station':      $label = __('Fuel station' ,'casawp');break;
              case 'garden-apartment':      $label = __('Garden apartment' ,'casawp');break;
              case 'golf-course':      $label = __('Golf course' ,'casawp');break;
              case 'granny-flat':      $label = __('Granny flat' ,'casawp');break;
              case 'hair-salon':      $label = __('Hair salon' ,'casawp');break;
              case 'home':      $label = __('Home' ,'casawp');break;
              case 'horse-box':      $label = __('Horse box' ,'casawp');break;
              case 'hospital':      $label = __('Hospital' ,'casawp');break;
              case 'indoor-swimming-pool':      $label = __('Indoor swimming pool' ,'casawp');break;
              case 'indoor-tennis-court':      $label = __('Indoor tennis court' ,'casawp');break;
              case 'industrial-building-plot':      $label = __('Industrial building plot' ,'casawp');break;
              case 'industrial-property':      $label = __('Industrial property' ,'casawp');break;
              case 'laboratory':      $label = __('Laboratory' ,'casawp');break;
              case 'library':      $label = __('Library' ,'casawp');break;
              case 'residential-commercial-building':      $label = __('Residential / commercial building' ,'casawp');break;
              case 'maisonette':      $label = __('Maisonette' ,'casawp');break;
              case 'market-garden':      $label = __('Market garden' ,'casawp');break;
              case 'mini-golf-course':      $label = __('Mini-golf course' ,'casawp');break;
              case 'mountain-farm':      $label = __('Mountain farm' ,'casawp');break;
              case 'movie-theater':      $label = __('Movie theater' ,'casawp');break;
              case 'multistorey-car-park':      $label = __('Multistorey car park' ,'casawp');break;
              case 'nursing-home':      $label = __('Nursing home' ,'casawp');break;
              case 'old-age-home':      $label = __('Old-age home' ,'casawp');break;
              case 'open-slot':      $label = __('Open slot' ,'casawp');break;
              case 'orphanage':      $label = __('Orphanage' ,'casawp');break;
              case 'outdoor-swimming-pool':      $label = __('Outdoor swimming pool' ,'casawp');break;
              case 'part-of-a-house':      $label = __('Part of a house' ,'casawp');break;
              case 'party-room':      $label = __('Party room' ,'casawp');break;
              case 'patrician-house':      $label = __('Patrician house' ,'casawp');break;
              case 'penthouse':      $label = __('Penthouse' ,'casawp');break;
              case 'pub':      $label = __('Pub' ,'casawp');break;
              case 'retail':      $label = __('Retail' ,'casawp');break;
              case 'retail-space':      $label = __('Retail space' ,'casawp');break;
              case 'riding-hall':      $label = __('Riding hall' ,'casawp');break;
              case 'roof-flat':      $label = __('Roof flat' ,'casawp');break;
              case 'row-house':      $label = __('Row house' ,'casawp');break;
              case 'sanatorium':      $label = __('Sanatorium' ,'casawp');break;
              case 'sauna':      $label = __('Sauna' ,'casawp');break;
              case 'shopping-center':      $label = __('Shopping center' ,'casawp');break;
              ...
              case 'solarium':      $label = __('Solarium' ,'casawp');break;
              case 'sports-hall':      $label = __('Sports hall' ,'casawp');break;
              case 'storage-room':      $label = __('Storage room' ,'casawp');break;
              case 'tennis-court':      $label = __('Tennis court' ,'casawp');break;
              ...
              case 'warehouse':      $label = __('Warehouse' ,'casawp');break;
              case 'workshop':      $label = __('Workshop' ,'casawp');break;
          }
        }
    ...
    public function casawp_convert_utilityKeyToLabel($key){
        switch ($key) {
            ...
            case 'construction': return __('Construction' ,'casawp');break;
        }
    }
