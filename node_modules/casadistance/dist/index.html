...
<html>
<head>
	<title>Casadistance</title>
<link href="./style.css" rel="stylesheet"></head>
<body>
	<!--
		Font Awesome is in following flavours available
		Free Solid
		Free Regular
		Pro light
		Pro Solid
	...
	<div class="casadistance__placeholder" id="casadistancePlaceholder">
		<button class="casadistance__placeholder__show-btn" id="casadistanceShowBtn">Click me to load</button>
	</div>
	<div class="casadistance"
		id="casadistance"
		style="display: none"
		data-load-map-on-click="false"
		data-lat = "37.8462913"
		data-lng = "-0.7656085"
		data-zoom="10"
		...
		data-marker-poi-size="20px"
		data-marker-poi-color="#A58962"
		data-marker-poi-active-color="#d63a7a"
		...
		<ul class="casadistance__menu__list">
			...
			<li class="casadistance__menu__item">
				<button class="casadistance__menu__button" id="casadistanceShowAirports">
					<span class="casadistance__menu__buttoninner">
						<svg width="24px" height="21px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M462.5 192.319H353.904l-33.695-64.33c6.53-.113 11.79-5.433 11.79-11.99V76c0-6.627-5.373-12-12-12h-33.307l-26.298-50.208C255.257 4.858 245.982 0 236.714 0h-54.175c-17.549 0-30.473 16.313-26.563 33.331l27.989 160.119c-20.696 1.057-40.83 2.827-58.722 5.169l-31.987-57.441-.259-.447c-4.896-8.161-13.85-13.23-23.366-13.23H29.723c-17.213 0-30.09 15.749-26.721 32.594l13.41 67.052C5.51 235.553 0 245.225 0 256.001c0 10.775 5.51 20.447 16.412 28.854l-13.41 67.049c-3.375 16.877 9.542 32.597 26.722 32.595l39.911-.001c9.516-.002 18.467-5.072 23.362-13.23l32.245-57.887c17.892 2.342 38.025 4.112 58.723 5.169l-27.989 160.119C152.064 495.694 164.999 512 182.539 512h54.175c9.003 0 18.012-4.512 23.456-13.372L286.689 448H320c6.627 0 12-5.373 12-12v-40c0-6.558-5.262-11.878-11.793-11.99l33.697-64.332 108.596.002c48.364 0 113.5-16.362 113.5-63.68 0-47.602-65.772-63.681-113.5-63.681zm0 95.361l-128.441-.001L233.849 480h-45.621l33.588-192.14c-45.335-1.352-67.17-2.232-113.778-9.356l-41.205 73.994-31.315.001L55 256.001 35.517 159.5h31.315l41.206 73.996c46.89-7.168 68.859-8.017 113.777-9.356L188.228 32h45.621l100.21 192.319H462.5c32.513 0 81.5 10.7 81.5 31.681 0 23.203-56.152 31.68-81.5 31.68z"></path></svg>
						<span>Flughafen</span>
					</span>
				</button>
			</li>
