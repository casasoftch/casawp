<?php
  ...
  class Single {  
    ...
    public function setProperty($post){
      ...
      $this->address_street       = get_post_meta( get_the_ID(), 'property_address_streetaddress', $single = true );
      $this->address_streetnumber = get_post_meta( get_the_ID(), 'property_address_streetnumber', $single = true );
      $this->address_postalcode   = get_post_meta( get_the_ID(), 'property_address_postalcode', $single = true );
      $this->address_region       = get_post_meta( get_the_ID(), 'property_address_region', $single = true );
      $this->address_locality     = get_post_meta( get_the_ID(), 'property_address_locality', $single = true );
      $this->address_country      = get_post_meta( get_the_ID(), 'property_address_country', $single = true );
      $this->address_country_name = $this->conversion->countrycode_to_countryname($this->address_country);

      $this->property_geo_latitude  = get_post_meta( get_the_ID(), 'property_geo_latitude', $single = true );
      $this->property_geo_longitude = get_post_meta( get_the_ID(), 'property_geo_longitude', $single = true );


      $this->casa_id = get_post_meta( get_the_ID(), 'id', $single = true );
      ...
      $this->reference_id = get_post_meta( get_the_ID(), 'referenceId', $single = true );

      $this->start = get_post_meta( get_the_ID(), 'start', $single = true );
      ...
      $this->urls = get_post_meta( get_the_ID(), 'urls', $single = true );
      ...
      $features_json = get_post_meta( get_the_ID(), 'features', $single = true );
      if ($features_json) {
